...
# Params for CF trackers
__C.TRACK.CF_TYPE = 'kcf'
__C.TRACK.AUGMIX = False
__C.TRACK.AUGMIX_NUM = 3
__C.TRACK.CF_FEAT = [2]
...
__C.SIAMF.LAMBDA_V = 10.0
__C.SIAMF.LAMBDA_U = 0.00001
# updating learning rate
__C.SIAMF.LR_U = 0.01
__C.SIAMF.LR_V = 0.28
__C.SIAMF.TRANS = False
__C.SIAMF.LAYERS = [1]
__C.SIAMF.INTERVAL=30

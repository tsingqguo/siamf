...
class SFSiamRPNTracker(SiameseTracker):
    def __init__(self, model):
        super(SFSiamRPNTracker, self).__init__()
    ...
    def track(self, img,x_crop=[],ispert=False,frameidx=0):
        """
        args:
            img(np.ndarray): BGR image
        return:
        ...
        if cfg.SIAMF.TRANS and (frameidx%cfg.SIAMF.INTERVAL)==0:
